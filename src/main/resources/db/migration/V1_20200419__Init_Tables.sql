...
(
    id             BIGINT (20) NOT NULL,
    dis_count_type VARCHAR(255)   DEFAULT NULL,
    price          DECIMAL(19, 2) DEFAULT NULL,
    movie_id       BIGINT (20) DEFAULT NULL,
    PRIMARY KEY (id),
    KEY            FKiohrfd6pjfu5r39ctj9x1g5rw(movie_id),
    CONSTRAINT FKiohrfd6pjfu5r39ctj9x1g5rw FOREIGN KEY (movie_id) REFERENCES movie (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(
    ...
    PRIMARY KEY (id),
    KEY         FKoirlomiplmxi6uaqp6xxefg3r(discount_id),
    CONSTRAINT FKoirlomiplmxi6uaqp6xxefg3r FOREIGN KEY
        (discount_id) REFERENCES dis_count (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(
    ...
    KEY         FKkwmc33a48pxxop9w5y2rwd3s5(screen_id),
...
(
    id          BIGINT (20) NOT NULL,
    screen_time datetime(6) DEFAULT NULL,
    seq         INT (11) DEFAULT NULL,
    movie_id    BIGINT (20) DEFAULT NULL,
    PRIMARY KEY (id),
    KEY         FK19or81yns51vp76dwleoltne9(movie_id),
